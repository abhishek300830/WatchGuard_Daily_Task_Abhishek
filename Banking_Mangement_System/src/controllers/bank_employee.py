...
class BankEmployee(User):
    ...
    def __approve_withdrawn_request(user_id, amount, done_by, request_id):
        ...
        update_item(queries.UPDATE_IN_ACCOUNT_WITHDRAWN_REQUESTS, ("Approved", "Manager", comments, request_id))
    ...
    def __reject_withdrawn_request(user_id, amount, request_id):
        ...
        update_item(queries.UPDATE_IN_ACCOUNT_WITHDRAWN_REQUESTS, ("Rejected", "Manager", comments, request_id))
